    ...
    menuItems: [
      {
        ...
        route: "/unassigned",
        // children: [
        //   { label: "Unassigned", route: "/unassigned" },
        //   { label: "Assigned", route: "/assigned" },
        //   { label: "Dispatched", route: "/dispatched" },
        //   { label: "Delivered", route: "/delivered" },
        //   { label: "Cancelled", route: "/cancelled" },
        //   { label: "Returned", route: "/returned" },
        // ],
      },
      {
        icon: (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 2.25C6.61522 2.25 2.25 6.61522 2.25 12C2.25 17.3848 6.61522 21.75 12 21.75C17.3848 21.75 21.75 17.3848 21.75 12C21.75 6.61522 17.3848 2.25 12 2.25ZM12 0.75C18.2132 0.75 23.25 5.7868 23.25 12C23.25 18.2132 18.2132 23.25 12 23.25C5.7868 23.25 0.75 18.2132 0.75 12C0.75 5.7868 5.7868 0.75 12 0.75ZM12.75 6C12.75 5.58579 12.4142 5.25 12 5.25C11.5858 5.25 11.25 5.58579 11.25 6V12C11.25 12.3315 11.4185 12.6317 11.6967 12.8033L15.1967 14.8033C15.5587 15.0232 16.0232 14.9163 16.2431 14.5543C16.4631 14.1923 16.3562 13.7278 15.9942 13.5079L12.75 11.5765V6Z"
              fill=""
            />
          </svg>
        ),
